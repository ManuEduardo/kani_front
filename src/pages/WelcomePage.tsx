...
const WelcomePage = () => {
  ...
  return (
    <div className="bg-purple-500 min-h-screen flex flex-col justify-between relative overflow-hidden">
      <h2 className="text-2xl text-purple-50 ml-12 mt-11 font-bold">Bienvenido</h2>
      ...
      <div>
        ...
        <button className="block bg-amber-400 text-lg text-amber-50 w-max mx-auto py-3 px-6 rounded-md shadow-xl font-bold absolute top-3/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
        onClick={startClick}>
          Click para iniciar
        </button>
      </div>
