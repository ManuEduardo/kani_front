  ...
  return (
    <div className=" flex flex-col justify-between min-h-screen">
      ...
      <div className="h-14 bg-purple-500 mx-6 my-2 rounded-lg shadow-2xl flex justify-around">
        <img src={CoindMenu} alt="monedas menu" className=" w-10 h-10 my-auto"/>
        <img src={ToolsMenu} alt="herramientas menu" className=" w-10 h-10 my-auto"/>
        <img src={HomeMenu} alt="home menu" className=" w-10 h-10 my-auto"/>
        <img src={ProfileMenu} alt="perfil menu" className=" w-10 h-10 my-auto"/>
      </div>
    </div>
  );
};
